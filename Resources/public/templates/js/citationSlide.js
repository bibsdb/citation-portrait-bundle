...
if (!window.slideFunctions['citation']) {
  window.slideFunctions['citation'] = {
    /**
     * Setup the slide for rendering.
     * @param scope
     *   The slide scope.
     */
    setup: function setupCitationSlide(scope) {
     ...
     *   The region object.
     */
    run: function runCitationSlide(slide, region) {
      region.itkLog.info("Running citation slide: " + slide.title);

      var duration = slide.duration !== null ? slide.duration : 25;
